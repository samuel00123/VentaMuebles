...
def productos_view(request,pagina):
	...
	try:
		page = int(pagina) #sacar del pagineitor cuantas paginas tiene
	except:
		page = 1 #convierte lo que se manda a 1
	try:
		productos = paginator.page(page) #traer los productos de esa pagina
	except (EmptyPage,InvalidPage):
		productos = paginator.page(paginator.num_pages)# si se genera una execpcion que nos envie la ultima pagina
